        ...
        <div className="bg-[url('/water-bg.png')] bg-center bg-cover bg-no-repeat w-full aspect-[9/16] text-white flex flex-col items-center relative">
            ...
            */}
            ...
            <div className='px-3 w-full'>
                ...
                <div className={`text-2xs ${slide.slide_type === 'hero' ? 'text-left ml-5' : 'text-center mr-2'}`}>{slide.line_2}</div>
                <div className={`text-2xs ${slide.slide_type === 'hero' ? 'text-right mr-6' : 'text-center ml-3'}`}>{slide.line_3}</div>
